...
async def create_product_route(product: schemas.ProductCreate, db: Session = Depends(get_db)):
...
async def update_product_route(product_id: int, product: schemas.ProductUpdate, db: Session = Depends(get_db)):
...
async def create_order_route(order: schemas.OrderCreate, db: Session = Depends(get_db)):
...
async def update_order_route(order_id: int, order: schemas.OrderUpdate, db: Session = Depends(get_db)):
